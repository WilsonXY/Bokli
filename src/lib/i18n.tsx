...
export const DICTIONARY = {
  zh: {
    ...
    signingIn: "登录中...",
    loginError: "账号或密码不正确",
    loginRateLimited: "尝试次数过多，请在 15 分钟后再试",
  ...
  en: {
    ...
    loadError: "Failed to load data. Please refresh or try again later.",
    retry: "Retry",
