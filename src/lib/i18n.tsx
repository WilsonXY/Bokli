...
export const DICTIONARY = {
  zh: {
    ...
    cashOnHand: "实际现金盘点 (Cash)",
    cashOnHandHint: "点算所得的纸币与硬币总额",
    tngOnHand: "Touch 'n Go 期末余额",
    tngOnHandHint: "电子钱包期末实际结余",
    expectedNet: "账面净利润",
    actualTotal: "实点总金额",
  ...
  en: {
    ...
    cashOnHandHint: "Total physical banknotes and coins counted",
    tngOnHand: "Touch 'n Go Ending Balance",
    tngOnHandHint: "End-of-month e-wallet closing balance",
    ...
    btnPerformClose: "Close Month & Lock",
