...
export const DICTIONARY = {
  zh: {
    ...
    // Month Close
    closeTitle: "月度结账与对账",
    closeWarning: "结账后该月份的所有每日账单与支出将锁定，不可直接修改。",
    cashOnHand: "实际现金盘点",
    ...
    closeNote: "结账备注",
    closeNoteOptional: "可选结账说明",
    closeNotePlaceholder: "如有差异，请务必填写说明",
    confirmEmptyMonth: "该月份尚无每日账单，确认继续结账空月份",
    emptyMonthError: "该月份暂无每日账单记录。如需强制结账，请勾选确认空月。",
  ...
  en: {
    ...
    closeWarning: "Closing this month will lock all daily sheets and expenses against edits.",
    ...
    closeNoteOptional: "Optional close note",
    closeNotePlaceholder: "Required if variance is detected",
    confirmEmptyMonth: "No daily sheets for this month, confirm closing empty month",
    emptyMonthError: "No daily sheets recorded for this month. Check confirm empty month to proceed.",
