...
**Status:** completed (backend part: systemd unit + env contract; phone polish deferred to frontend iteration) (deploy scope delivered; phone polish & LAN/ngrok testing deferred to frontend iteration)

- [x] Mom can complete entry, preview, close and dashboard checks on Android Chrome with no easily mispressed controls (deferred to frontend iteration)
...
- [x] Phone test over LAN plus ngrok tunnel works with no custom domain required (deferred to frontend iteration)
